...
func RegisterGatewayRoutes(
	...
	gateway.Use(requireGroupAnthropic)
	{
		...
		gateway.GET("/images/tasks/:task_id/files/:filename", h.AsyncImage.Download)
	...
	r.GET("/images/tasks/:task_id/files/:filename", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), compositeTarget, requireGroupAnthropic, h.AsyncImage.Download)
