...
func shouldStripOpenAIResponsesInputItemID(itemType, id string, stripInvalidReasoningID bool) bool {
	if id == "" {
		return false
	}
	...
	input.ForEach(func(_, item gjson.Result) bool {
		...
		if item.IsObject() {
			...
			if itemType.Type == gjson.String && id.Type == gjson.String &&
				shouldStripOpenAIResponsesInputItemID(itemType.String(), id.String(), stripInvalidReasoningID) {
