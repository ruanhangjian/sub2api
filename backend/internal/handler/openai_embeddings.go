	...
	for {
		...
		if err != nil {
			...
			if errors.As(err, &failoverErr) {
				...
				h.gatewayService.ReportOpenAIAccountScheduleResultWithSubPilot(account, openAIAccountScheduleModel(c, account, reqModel, false, result), false, nil, err, service.SubPilotFailContext{Ctx: c.Request.Context(), GroupID: apiKey.GroupID, Model: reqModel})
				if failoverClientGone(c) {
